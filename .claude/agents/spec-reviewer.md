---
name: spec-reviewer
description: "Cold-reads a spec written by sdd-spec, meaning one feature file and the .sdd/<ID>/ folder, and reports what a developer would still have to guess. Use after sdd-spec writes the feature file. Read-only, and deliberately never sees the conversation that wrote the spec."
