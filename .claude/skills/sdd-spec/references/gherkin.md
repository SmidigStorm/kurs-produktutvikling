...
| Do | Not |
|---|---|
| **Reuse the repo's steps.** Read `e2e/steps/` first and phrase scenarios in the words that already have definitions | A step one word different from an existing one — it costs a new definition for no new behaviour |
