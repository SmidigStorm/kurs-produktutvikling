Feature: Staff queue
  ...
  Rule: Every registered arrival joins the queue
  ...
  Rule: A re-triaged patient takes the place their new level gives them
  ...
  Rule: A patient marked done leaves the queue
